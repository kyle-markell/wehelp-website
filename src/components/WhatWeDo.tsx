            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
                    ...
                    <div className="flex-1 w-full flex justify-center lg:justify-end">
                        <div className="relative w-[300px] h-[600px] rounded-[3rem] border-[12px] border-gray-900 bg-gray-900 shadow-2xl overflow-hidden shrink-0">
                            {/* iPhone notch top */}
                        ...
                        {features.map((feature, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <p className={`text-base leading-relaxed ${isActive ? 'text-gray-800' : 'text-gray-500'}`}>
                                        {feature.description}
                                    </p>
                                </button>
                            );
